...
export default function SignupPage() {
  ...
  return (
    <main className="auth-surface flex min-h-screen items-center justify-center px-6 py-12 text-slate-50">
      <div className="auth-card w-full max-w-xl rounded-3xl p-8 sm:p-10">
